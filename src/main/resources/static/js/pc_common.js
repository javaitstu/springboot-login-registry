...
function AjaxAddCart(goods_id,num,to_catr)
{
        ...
        if($("#buy_goods_form").length > 0){
                $.ajax({
                        type : "POST",
                        url:"/index?m=Home&c=Cart&a=ajaxAddCart",
                        ...
                        success: function(data){	
							   ...
							   if(to_catr == 1)  //直接购买
							   {
								   location.href = "/index?m=Home&c=Cart&a=cart";   
							   }
							   else
							   {
									...
									layer.open({
										  ...
										  area: ['490px', '386px'], //宽高
                                          content:["/index?m=Home&c=Goods&a=open_add_cart","no"],
                ...
                $.ajax({
                        ...
                        success: function(data){   							   							   
							   if(data.status == -1)
							   {
									location.href = "/index?m=Home&c=Goods&a=goodsInfo&id="+goods_id;   
							   }
							   else
							   {
								    // 加入购物车有误
									...
									layer.open({
										  ...
										  skin: 'layui-layer-rim', //加上边框
										  area: ['490px', '386px'], //宽高
										  content:"/index?m=Home&c=Goods&a=open_add_cart"
									});							   
							   }							   							   
                        }
                });            
